...
resource "aws_instance" "CLO835_week_04_Assignment_01_ec2_linux" {
  # ami                                = "ami-0715c1897453cabd1"
  ami      = data.aws_ami.latest_amazon_linux.id
  key_name = aws_key_pair.key_pair_jal_patel.key_name
  # instance_type                      = "t2.micro"
  instance_type = lookup(var.instance_type, var.env)
  # subnet_id                          = aws_subnet.CLO835_week_04_Assignment_01_subnet_01.id
  # security_groups             = [aws_security_group.CLO835_week_04_Assignment_01_sg.id]
  vpc_security_group_ids      = [aws_security_group.CLO835_week_04_Assignment_01_sg.id]
  ...
  # tags = {
  #   Name = "EC2 Instance for CLO835_week_04_Assignment_01"
  # }
...
resource "aws_key_pair" "key_pair_jal_patel" {
  key_name   = "CLO835_Assignment_01"
  public_key = file("${local.name_prefix}.pub")
}

# provisioning a public subnet in the default VPC
# resource "aws_subnet" "CLO835_week_04_Assignment_01_subnet_01" {
...
#   tags = {
#     Name = "CLO835_week_04_Assignment1_Subnet"
#   }
# }

# security group creation
resource "aws_security_group" "CLO835_week_04_Assignment_01_sg" {
  name        = "CLO835_week_04_Assignment_01_security_group"
